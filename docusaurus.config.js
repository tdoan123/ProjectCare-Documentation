...
const config = {
  title: 'TeamYellow Documentation',
  tagline: 'ASP.NET Core MVC Healthcare Client Management System - Architecture & Technical Documentation',
  ...
  projectName: 'ProjectCare-Documentation', 
